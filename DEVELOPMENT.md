...
1. From the repo root, run `python buildAddon.py`. The script will generate a portable Blender add-on under `dist_extras/deadline-cloud-blender-addon.zip`.
